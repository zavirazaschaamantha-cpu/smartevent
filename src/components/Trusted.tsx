...
export default function Trusted() {
  const logos = ['UI', 'ITB', 'UGM', 'ITS', 'IPB', 'UNAIR'];
    ...
    <section className="px-10 py-12 bg-white border-y border-gray-100">
      <div className="container mx-auto max-w-7xl flex flex-col md:flex-row items-center justify-between gap-12">
        <div className="flex flex-col gap-3 items-center md:items-start text-center md:text-left">
          <p className="text-xs font-bold text-gray-400 uppercase tracking-[0.2em]">Mitra Resmi</p>
        ...
        <div className="flex items-center gap-12 md:gap-16">
          <div className="text-center md:text-right">
            ...
            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Acara Dibuat</p>
          </div>
          <div className="text-center md:text-right">
            <p className="text-3xl md:text-4xl font-display font-extrabold text-gray-900 leading-none mb-2">98%</p>
            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Rating Pengguna</p>
          </div>
        </div>
      </div>
    </section>
